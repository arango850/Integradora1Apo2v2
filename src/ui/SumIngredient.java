...
public class SumIngredient extends Stage {
	...
	public SumIngredient() {
		 try {
	            FXMLLoader loader = new FXMLLoader(getClass().getResource("SumIngredient.fxml"));
	...
	public  void init() {
		// TODO Auto-generated method stub
			...
			ingredient.increAmount(newAmount1);
		});
